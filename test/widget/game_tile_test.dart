...
void main() {
  group('GameTile Widget Tests', () {
    testWidgets('should display game name correctly', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should display exact release date correctly', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should display month release date correctly', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(
    ...
    testWidgets('should display quarter release date correctly', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(
    ...
    testWidgets('should display year release date correctly', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(
        name: 'Year Date Game',
    ...
    testWidgets('should display TBD when no release date available', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(name: 'TBD Game', firstReleaseDate: null);
    ...
    testWidgets(
      'should display TBD when category is unreliable but fixed by logic',
    ...
    testWidgets('should display platforms when available', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(
    ...
    testWidgets('should not display platform chips when platforms is null', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(name: 'No Platform Game', platforms: null);
    ...
    testWidgets('should display placeholder image when cover is null', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(name: 'No Cover Game', cover: null);
    ...
    testWidgets('should display cover image when available', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(
        name: 'Cover Game',
    ...
    testWidgets('should handle platform without abbreviation', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(
        name: 'Platform Game',
    ...
    testWidgets('should handle platform with neither name nor abbreviation', (
      WidgetTester tester,
    ) async {
      final game = _createTestGame(
        name: 'Unknown Platform Game',
        platforms: [
          Platform(id: 1, name: null, abbreviation: null, url: 'unknown-url'),
        ],
      );
    ...
    testWidgets('should be tappable and create navigation route', (
      WidgetTester tester,
    ) async {
    ...
    group('date formatting priority tests', () {
      testWidgets('should prioritize human format over category for quarters', (
        WidgetTester tester,
      ) async {
        final game = _createTestGame(
      ...
      testWidgets('should use dateFormat when category is unreliable', (
        WidgetTester tester,
      ) async {
        final game = _createTestGame(
      ...
      testWidgets(
        'should use most specific category from multiple release dates',
        (WidgetTester tester) async {
          final game = _createTestGame(
    ...
    group('edge cases', () {
      testWidgets('should handle empty platform list', (
        WidgetTester tester,
      ) async {
        final game = _createTestGame(
      ...
      testWidgets('should handle future dates correctly', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('should handle very long game names', (
        WidgetTester tester,
      ) async {
        final game = _createTestGame(
          name:
              'This is a very long game name that should still be displayed properly in the game tile widget without breaking the layout or causing overflow issues',
        );
...
Widget _createTestApp(Game game) {
  return MaterialApp(
    home: Scaffold(body: GameTile(game: game)),
  );
}
