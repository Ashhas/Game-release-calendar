...
void main() {
  group('Error Widgets Tests', () {
    testWidgets('AppErrorWidget should display error message and retry button', (WidgetTester tester) async {
    ...
    testWidgets('AppErrorWidget should handle non-retryable errors', (WidgetTester tester) async {
    ...
    testWidgets('AppErrorWidget should handle null onRetry callback', (WidgetTester tester) async {
    ...
    testWidgets('AppErrorWidget should display custom title', (WidgetTester tester) async {
    ...
    testWidgets('AppErrorWidget should be accessible', (WidgetTester tester) async {
    ...
    testWidgets('AppLoadingWidget should display loading indicator', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(
            extensions: [
    ...
    testWidgets('AppLoadingWidget should display custom message', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(
            extensions: [
    ...
    testWidgets('AppEmptyWidget should display title and message', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(
            extensions: [
    ...
    testWidgets('AppEmptyWidget should display action button when provided', (WidgetTester tester) async {
